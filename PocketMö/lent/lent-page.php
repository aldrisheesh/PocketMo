...
// Prepare SQL SELECT statement for lent transactions
$lentSql = "SELECT Lent_Date, Amount, Name, Payment_Amount, Balance, Due_Date FROM lent WHERE User_Id = ? ORDER BY Due_Date ASC"; // Changed to sort by Due_Date
$lentStmt = $conn->prepare($lentSql);
$lentStmt->bind_param("i", $userId);
$lentStmt->execute();
$lentResult = $lentStmt->get_result();

// Store lent transactions to display later
$transactions = [];
...
// Calculate the total amount lent, only including transactions with a balance > 0
$totalAmount = 0;
...
// Calculate the receivable amount (which is the outstanding amount)
$receivableAmount = $repaidAmount; // This is the outstanding amount after filtering

// Calculate the progress percentage
$progressPercentage = $totalAmount > 0 ? ($receivableAmount / $totalAmount) * 100 : 0;
...
<body>
    <div class="main-sidebar"> <!--sidebar start-->
        ...
        <div class="sidebar">
            ...
            <div class="additional-links">
                <a href="./lent-page.php" class="text1">Money Lent</a>
    ...
    <div id="alert" class="alert" style="display: none;">
        ...
        <div class="home"> <!--header start-->
            ...
            <span class="home-page-1">Lent Page</span>
            <div class="group-2">
        ...
        <div class="box"> <!-- white container start -->
            <div class="stat-container"> <!-- stat container start -->
                ...
                <div class="box-total-money-lent">
                    <p class="box-title">Total Money Lent</p>
                    <p class="total-amount">₱ <?php echo number_format($totalAmount, 2); ?></p> <!-- Total Money Lent -->
                </div>
                ...
                <div class="box-for-bar">
                    ...
                    <div class="text-bar">
                        <p>Receivable: ₱<?php echo number_format($receivableAmount, 2); ?> / ₱<?php echo number_format($totalAmount, 2); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="table-container">
                <div class="table-scroll"> <!-- Scrollable container -->
                    <table>
                        ...
                        <tbody>
                            ...
                            foreach ($transactions as $transaction): ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($transaction['Lent_Date']); ?></td>
                ...
                <div class="button-container">
                    <a href="./new-transact-lent.php" class="btn btn-rec">
                        <img src="../assets/images/plus-icon.png" alt="Add Icon" class="btn-icon"> Record
                    </a>
                    <a href="./upd-transact-lent.php" class="btn btn-upd">
    ...
    <script>
        ...
        // Set the "Money Lent" link as active
        const moneyLentLink = document.querySelector('.text1');
        moneyLentLink.classList.add('active');
